...
I modified that beast mode to be more robust, and I love it.
...
and "[LANGUAGE/FRAMEWORK]" should be replaced with what your code base is.

based off from [@burkeholland](https://gist.github.com/burkeholland)
...
-------- File Contents Below - view the raw file and copy paste to file --------
...
## Role Assignment:
Based on the task type, you are now an **expert [TYPESCRIPT/ASTRO/REACT] developer** specializing in the identified area. Your expertise includes:
